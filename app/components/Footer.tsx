        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">LuxuryStore</span>
            </div>
            <p className="text-gray-400 mb-4 max-w-md">
              Your premier destination for luxury products and exceptional shopping experience. 
              We curate the finest selection of premium goods.
            </p>
